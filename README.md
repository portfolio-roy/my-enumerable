...
**My Enumerable** is command line application built in ruby to implement a subset(all, any & filter) of the enumerable functionality.
...
In order to run this project you need to have `Ruby` installed on your computer
...
```sh
  cd my-folder
  git clone git@github.com:portfolio-roy/my-enumerable.git
```

### Install [optional]

Install inters for this project with:
...
- [ ] **Add more functionality for the enumerable**
...
If you like this project please give us some stars on github
